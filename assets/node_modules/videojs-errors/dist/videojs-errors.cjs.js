...
const initPlugin = function (player, options) {
  ...
  const resetMonitor = function () {
    ...
    if (document__default["default"].visibilityState === 'hidden' && (player.muted() || disableValueMatch(disableValues, options.backgroundTimeout)) || document__default["default"].visibilityState === 'visible' && disableValueMatch(disableValues, options.timeout)) {
      return;
    ...
    }, document__default["default"].visibilityState === 'hidden' ? options.backgroundTimeout : options.timeout);
  ...
  const onPlayStartMonitor = function () {
    ...
    player.off(document__default["default"], 'visibilitychange', onPlayStartMonitor);
    player.on(document__default["default"], 'visibilitychange', onPlayStartMonitor);
  };
  ...
  const onErrorHandler = function () {
    ...
    const content = document__default["default"].createElement('div');
