...
},{"throttle-debounce":5}],8:[function(require,module,exports){
(function (global){
'use strict';
...
_qunit2['default'].module('videojs-responsive-layout', {
...
_qunit2['default'].test('registers itself with video.js', function (assert) {
  ...
  assert.strictEqual(Player.prototype.responsiveLayout, _srcPlugin2['default'], 'videojs-responsive-layout plugin was registered');

  this.player.responsiveLayout();

  // Tick the clock forward enough to trigger the player to be "ready".
  this.clock.tick(1);

  assert.ok(this.player.hasClass('vjs-responsive-layout'), 'the plugin adds a class to the player');
});

}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"../src/plugin":7,"global/document":2}]},{},[8]);
